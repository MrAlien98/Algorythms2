...
public class PanelOpciones extends JPanel implements ActionListener{
	...
	public PanelOpciones(VentanaPrincipal ventana) {
		...
		titulo=new JLabel("WACHALO");
		titulo.setFont(new Font("ARCADECLASSIC", 0, 80));
		...
		butIniciar.setFont(new Font("ARCADECLASSIC", 0, 30));		
		...
		butPuntajes.setFont(new Font("ARCADECLASSIC", 0, 30));
		butPuntajes.setForeground(Color.WHITE);
		
		butNaves=new JButton("Naves");
		butNaves.addActionListener(this);
		butNaves.setActionCommand(ENEMIGOS);
		butNaves.setOpaque(false);
		butNaves.setContentAreaFilled(false);
		butNaves.setBorderPainted(false);
		butNaves.setFont(new Font("ARCADECLASSIC", 0, 30));	
		butNaves.setForeground(Color.WHITE);
		...
		butInfo.setFont(new Font("ARCADECLASSIC", 0, 30));
		butInfo.setForeground(Color.WHITE);
	...
	public void paintBackground(Graphics g) {
		...
		ImageIcon logo=new ImageIcon("src/data/background.gif");
	...
	public void paintTxt(Graphics g) {
		...
		g.setFont(new Font("ARCADECLASSIC", 0, 50));
		g.drawString( "1UP", 1, 30 );
		g.drawString(Integer.toString(ventana.getGame().getUsuario().getPuntos()), 60, 60);
		g.drawString("HIGH SCORE", 375, 30);
